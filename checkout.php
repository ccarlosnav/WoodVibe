      ...
      <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Language</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            <li><a href="checkout">English</a></li>
                            <li><a href="ES_checkout.php">Spanish</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
  ...
  <section id="checkout" class="checkout section-bg">
    <div class="container" data-aos="fade-up">
      ...
      <div class="section-title">
        <h2>Checkout</h2>
        <h3>Complete your <span>Order</span></h3>
        ...
        <div class="col-lg-6">
          <div class="box checkout-form">
            ...
            <form id="checkout-form" action="process_checkout.php" method="POST">
              ...
              <div class="row">
                <div class="col-md-6 form-group">
                  <label for="ciudad">Country</label>
                ...
                function validateCheckoutForm() {
                  ...
                  if (!postalCodePattern.test(codigo_postal)) {
                    Swal.fire({
                      icon: 'error',
                      title: 'ERROR',
                      text: 'Postal code must be exactly 4 digits.',
                    });
                    return false;
                  }
                  ...
                  if (!duiPattern.test(dui)) {
                    Swal.fire({
                      icon: 'error',
                      title: 'ERROR',
                      text: 'DUI must be in the format 12345678-9.',
                    });
                    return false;
                  }
                ...
                paypal.Buttons({
                  ...
                  onApprove: function(data, actions) {
                    return actions.order.capture().then(function(details) {
                      Swal.fire({
                        ...
                        window.location.href = 'EN_AccionCarta.php?action=placeOrder'; // Redirige a la página de agradecimiento
                      });
                    });
                  },
                  onCancel: function(data) {
                    Swal.fire({
                      ...
                      window.location.href = 'checkout.php'; // Redirige a la página de IDcompra
                    });
                  }
