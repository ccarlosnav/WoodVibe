...
<head>
  ...
  <title>WoodVibe - Pagina Principal</title>
...
<body>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="ES_index.php">WoodVibe<span>.</span></a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="ES_registro.php">Registrarse</a></li>
          ...
          <li class="dropdown"><a href="#"><span>Idioma</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li><a href=" ES_index.php">Español</a></li>
            </ul>
          </li>
        </ul>
  ...
  <main id="main">
    ...
    <section id="about" class="about section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <h3>Conozcanos <span></span></h3>
          <p>Somos un equipo de programadores, con la visión de crear un sitio web totalmente funcional, y por lo tanto,
            hacer una tienda online sobre la venta de diferentes tipos de muebles para cada área del hogar.</p>
        </div>
            ...
            <ul>
              ...
              <li>
                ...
                <div>
                  ...
                  <p>En nuestro sitio, no le venderemos productos que no valgan lo que cuestan, puede estar seguro de ello.</p>
                </div>
              </li>
            </ul>
            <p>
    ...
    <section id="services" class="services">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Servicios</h2>
          <h3>Echa un vistazo a nuestros <span>servicios</span></h3>
          <p>Aquí encontrará los servicios que le ofrecemos como equipo y como sitio de compra de muebles.</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              ...
              <h4><a href="">Contamos con un servicio excelente</a></h4>
              <p>Le ofreceremos la mejor experiencia de compra y entrega.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box">
              ...
              <p>Todos los pasos que das para comprar tus muebles son seguros</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              ...
              <h4><a href="">Entregas a todas las áreas de Santa Tecla</a></h4>
              <p>Somos un sitio de inicio, por lo que sólo enviaremos a Santa Tecla.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              ...
              <p>Le ofreceremos las mejores imágenes y presentación de manera detallada para que esté seguro de lo que compra.</p>
            </div>
          </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 footer-links">
          <h4>Idioma</h4>
          <ul>
            <li><i class="bx bx-chevron-right"></i> <a href="index.php">Inglés</a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="ES_index.php">Español</a></li>
          </ul>
        </div>
