...
// SQL query to get desk products
$sql = "SELECT p.* FROM mis_productos p 
        INNER JOIN categorias c ON p.categoria_id = c.id 
        WHERE c.nombre = 'Desks'";
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Language</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="EN_desks.php">English</a></li>
              <li><a href="ES_desks.php">Spanish</a></li>
            </ul>
          </li>
          <li class="dropdown">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          if (!empty($productos)) {
            ...
            echo "<p>No desk products found.</p>";
          }
          ?>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Language</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="EN_desks.php">English</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="ES_desks.php">Spanish</a></li>
            </ul>
          </div>
