...
// Consulta SQL para obtener los productos de Beds
        ...
        <section id="team" class="team section-bg">
            <div class="container" data-aos="fade-up">
                <div class="section-title">
                    <h2>Productos</h2>
                    <h3>Sección de <span>Camas</span></h3>
                ...
                <div class="row">
                    ...
                    <?php
                        ...
                        echo "<p>No se encontraron productos de camas.</p>";
                    }
                    ?>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 footer-links">
                        <h4>Idioma</h4>
                        <ul>
                            <li><i class="bx bx-chevron-right"></i> <a href="EN_beds.php">Inglés</a></li>
                            <li><i class="bx bx-chevron-right"></i> <a href="ES_beds.php">Español</a></li>
                        </ul>
                    </div>
