...
<head>
    ...
    <title>WoodVibe - Dashboard</title>
...
<button id="userDropdown" class="nav-link dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" onKeyPress="handleKeyPress(event)" onKeyDown="handleKeyDown(event)" onKeyUp="handleKeyUp(event)">
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            Users: <?php echo htmlspecialchars($num_users); ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link" href="DBusers.php">View Details</a>
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            Products: <?php echo htmlspecialchars($num_products); ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link" href="DBproducts.php">View Details</a>
                                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            Sales: <?php echo htmlspecialchars($num_sales); ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link" href="DBsales.php">View Details</a>
                                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        const comparisonData = {
            labels: ['Registered Users', 'Registered Products', 'Sales'],
            datasets: [{
        ...
        document.getElementById('downloadBtn').addEventListener('click', function () {
            ...
            doc.text('Comparison of Registered Users, Products, and Sales', 10, 10);
            const canvas = document.getElementById('comparisonChart');
            const imgData = canvas.toDataURL('image/png');
            doc.addImage(imgData, 'PNG', 10, 20, 180, 160);

            // Descargar el PDF
            doc.save('comparison-chart.pdf');
        });
    </script>
</body>
