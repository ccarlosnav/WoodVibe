...
// Consulta SQL para obtener los productos de tables
$sql = "SELECT p.* FROM mis_productos p 
        INNER JOIN categorias c ON p.categoria_id = c.id 
        WHERE c.nombre = 'Tables'";
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Language</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            <li><a href="EN_kitchen_tables.php">English</a></li>
                            <li><a href="ES_kitchen_tables.php">Spanish</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
        ...
        <section id="team" class="team section-bg">
            <div class="container" data-aos="fade-up">
                <div class="section-title">
                    <h2>Products</h2>
                    <h3>Tables <span>Section</span></h3>
                ...
                <div class="row">
                    ...
                    if (!empty($productos)) {
                        ...
                        echo "<p>No table products found.</p>";
                    }
                    ?>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 footer-links">
                        <h4>Language</h4>
                        <ul>
                            <li><i class="bx bx-chevron-right"></i> <a href="EN_kitchen_tables.php">English</a></li>
                            <li><i class="bx bx-chevron-right"></i> <a href="ES_kitchen_tables.php">Spanish</a></li>
                        </ul>
                    </div>
