...
// Consulta SQL para obtener los productos de open cabinets
...
<head>
    ...
    <title>WoodVibe - Open Cabinets</title>
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Language</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            <li><a href="EN_open_cabinets.php">English</a></li>
                            <li><a href="ES_open_cabinets.php">Spanish</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
        ...
        <section id="team" class="team section-bg">
            <div class="container" data-aos="fade-up">
                <div class="section-title">
                    <h2>Products</h2>
                    <h3>Open Cabinets <span>Section</span></h3>
                ...
                <div class="row">
                    ...
                    if (!empty($productos)) {
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <button type="button" class="btn btn-primary btn-custom" data-bs-toggle="modal"
                                                data-bs-target="#imageModal<?php echo $producto['id']; ?>">View Product</button>
                        ...
                        echo "<p>No open cabinets products found.</p>";
                    }
                    ?>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 footer-links">
                        <h4>Language</h4>
                        <ul>
                            <li><i class="bx bx-chevron-right"></i> <a href="EN_open_cabinets.php">English</a></li>
                            <li><i class="bx bx-chevron-right"></i> <a href="ES_open_cabinets.php">Spanish</a></li>
