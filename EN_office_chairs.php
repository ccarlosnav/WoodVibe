...
// Consulta SQL para obtener los productos de Office Chairs
$sql = "SELECT p.* FROM mis_productos p
        INNER JOIN categorias c ON p.categoria_id = c.id
        WHERE c.nombre = 'Office Chairs'";
...
<head>
  ...
  <title>WoodVibe - Office Chairs</title>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Categories</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li class="dropdown"><a href="#"><span>Living Room</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <li><a href="EN_sofas.php">Sofas</a></li>
                  <li><a href="EN_tvfurniture.php">TV Furniture</a></li>
                </ul>
              </li>
              <li class="dropdown"><a href="#"><span>Bedroom</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
              ...
              <li class="dropdown"><a href="#"><span>Bathroom</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
              ...
              <li class="dropdown"><a href="#"><span>Kitchen</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
          ...
          <li style="position: relative; list-style: none; display: inline-block; margin-right: 15px;">
            <a class="nav-link scrollto" href="EN_Cart.php" style="position: relative; display: inline-block;">
              <i class="fas fa-shopping-cart" style="color:#00BFFF; font-size: 1.2em; margin-right: 5px;"></i> Cart
            </a>
          </li>
          <li class="dropdown"><a href="#"><span>Language</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="EN_office_chairs.php">English</a></li>
              <li><a href="ES_office_chairs.php">Spanish</a></li>
            </ul>
          </li>
          <li class="dropdown">
    ...
    <section id="team" class="team section-bg">
      <div class="container" data-aos="fade-up">
        <div class="section-title">
          <h2>Products</h2>
          <h3>Office Chairs <span>Section</span></h3>
        ...
        <div class="row">
          ...
          if (!empty($productos)) {
                    ...
                    <div class="d-flex justify-content-between">
                      ...
                      <?php if ($producto['stock'] > 0) { ?>
                        <a class="btn btn-primary btn-custom add-to-cart"
                          href="EN_AccionCarta.php?action=addToCart&id=<?php echo $producto["id"]; ?>">Add to cart</a>
                      <?php } else { ?>
                ...
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <img src="imagenes/<?php echo htmlspecialchars($producto['image']); ?>" class="img-fluid"
                        alt="<?php echo htmlspecialchars($producto['name']); ?>">
                    </div>
                  </div>
                </div>
            ...
            echo "<p>No office chair products found.</p>";
          }
          ?>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Language</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="EN_office_chairs.php">English</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="ES_office_chairs.php">Spanish</a></li>
            </ul>
          </div>
