...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($usuario) || empty($password)) {
        ...
        $login_result = login_ES($usuario, $password);
    ...
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li><a class="nav-link scrollto" href="ES_registro.php">Registro</a></li>
                <li><a class="nav-link scrollto active" href="#hero">Iniciar sesión</a></li>
                <li class="dropdown"><a href="#"><span>Idioma</span> <i class="bi bi-chevron-down"></i></a>
                    <ul>
                        <li><a href="EN_login.php">Inglés</a></li>
                        <li><a href="ES_login.php">Español</a></li>
                    </ul>
                </li>
            </ul>
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                <div class="form-group">
                                    ...
                                    <input class="form-control py-2" id="inputEmailAddress" name="usuario" type="text" placeholder="Ingrese su nombre de usuario" />
                                </div>
                                <br>
                                
                                <div class="form-group">
                                    <label class="small mb-1" for="inputPassword">Contraseña</label>
                                    <input class="form-control py-2" id="inputPassword" name="password" type="password" placeholder="Ingrese su contraseña" />
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                    <button type="submit" class="btn btn-primary" id="loginButton">Acceder</button>
                                </div>
                            </form>
                        </div>
                        <div class="card-footer text-center">
                            <div class="small"><a href="ES_restorePass.php">Olvidó su contraseña?</a></div>
                        </div>
                    </div>
                </div>
            </div>
