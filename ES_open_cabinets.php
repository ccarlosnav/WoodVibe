...
// Consulta SQL para obtener los productos de cabinetes abiertos
$sql = "SELECT p.* FROM mis_productos p 
        INNER JOIN categorias c ON p.categoria_id = c.id 
        WHERE c.nombre = 'Open Cabinets'";
...
<head>
    ...
    <title>WoodVibe - Gabinetes Abiertos</title>
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Idioma</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            <li><a href="EN_open_cabinets.php">Inglés</a></li>
                            <li><a href="ES_open_cabinets.php">Español</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
        ...
        <section id="team" class="team section-bg">
            <div class="container" data-aos="fade-up">
                <div class="section-title">
                    <h2>Productos</h2>
                    <h3>Sección de <span>Gabinetes abiertos</span></h3>
                ...
                <div class="row">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <button type="button" class="btn btn-primary btn-custom" data-bs-toggle="modal" data-bs-target="#imageModal<?php echo $producto['id']; ?>">Ver Producto</button>
                    ...
                    <?php
                        ...
                        echo "<p>No se encontraron productos de cabinetes abiertos.</p>";
                    }
                    ?>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 footer-links">
                        <h4>Idioma</h4>
                        <ul>
                        <li><i class="bx bx-chevron-right"></i> <a href="EN_open_cabinets.php">Inglés</a></li>
                        <li><i class="bx bx-chevron-right"></i> <a href="ES_open_cabinets.php">Español</a></li>
                        </ul>
                    </div>
